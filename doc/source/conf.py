...
latex_documents = [
    (master_doc, 'CSDM.tex', 'CSDM Documentation',
     'Deepansh J. Srivastava', 'manual'),
]
...
man_pages = [
    (master_doc, 'csdm', 'CSDM Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'CSDM', 'CSDM Documentation',
     author, 'CSDM', 'One line description of project.',
     'Miscellaneous'),
]
