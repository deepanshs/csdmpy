...
# Here, the CSDM data file holds a sparse dependent variable. Upon import, the component
# of the dependent variable sparsely populate the coordinate grid. The
...
#%%
# Note, only eight values were listed in the dependent variable `components`
